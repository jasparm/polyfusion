import { ControllerState } from "./ControllerStates.js";
/**
 ...
 */
export function onMouseMove(event, controller) {
 ...
 * @param controller
 */
export function onMouseDown(event, controller) {
    switch (event.button) {
 ...
 * @param controller
 */
function onLeftMouseClick(event, controller) {
 ...
 * @param controller
 */
function onRightMouseClick(event, controller) {
 ...
 */
export function onMouseWheelEvent(event, controller) {
    if (controller.state === ControllerState.Insert) {
